...
func TestCreateTransferAPI(t *testing.T) {
	...
	account1.Curency = utils.USD
	account2.Curency = utils.USD
	account3.Curency = utils.EUR
	...
	testCases := []struct {
		...
		},
		{
			...
			body: gin.H{
				"from_account_id": account1.ID, // USD
				"to_account_id":   account3.ID, // EUR
				"amount":          amount,
				"currency":        utils.USD, // Request claims USD
			},
			setupAuth: func(t *testing.T, request *http.Request, tokenMaker token.Maker) {
				addAuthorization(t, request, tokenMaker, authorizationTypeBearer, user1.Username, time.Minute)
			},
